...
const items= [
    ...
    [
        "public/imgs/pc/dailyindiegame.png",
        "DailyIndieGame",
    ...
    [
        "public/imgs/pc/gamesmailru_cr.png",
        "игры@mail.ru",
...
export default class PcGames extends React.Component{
    // </tr>return row[3] === "" ? "" : "<button class=\"btn btn-default btn-xs\" onclick=\"openInNewTab('"+row[3]+"')\"><i class='glyphicon glyphicon-search'></i></button
                ...
                <table className="table table-striped table-bordered">
                {
                    items.map(function(item){
                        return <tr>
                            ...
                            <td>{item[3] === ""? "" : <button class="btn btn-secondary btn-xs"><i class='glyphicon glyphicon-search'></i>?</button>} </td>
                        </tr>
                    })
